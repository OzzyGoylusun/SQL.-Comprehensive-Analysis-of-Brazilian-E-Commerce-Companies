...
WITH COMPLETE_CATEGORY_TRANSLATION AS
	...
	ORDERS_AND_CATEGORIES AS(
		...
		--When I combine the Orders table with the Order_Items table, there is a duplication that pollutes the analysis because there are multiple items belonging to the same category.
